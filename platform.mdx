---
title: 'Platform'
description: 'High level overview of the Databerry platform'
---

Databerry let you bring data from anywhere (Datsources: Text, PDF, Word, PowerPpoint, Excel, Notion, Airtable, Google Sheets, etc..) into Datastores (container of multiple Datasources)
...
![Conversion](/images/databerry-overview.png)
