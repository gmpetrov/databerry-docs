...
api: 'POST https://api.chaindesk.ai/datastores/file-upload/generate-link/{datastoreId}'
...
```js
const apiUrl = 'https://api.chaindesk.ai';
const apiKey = 'XXX';
...
curl --location --request POST 'https://api.chaindesk.ai/datastores/file-upload/generate-link/<datastoreId>' \
